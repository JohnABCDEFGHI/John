...
import com.gyh.Hamburger.domain.*;
import com.gyh.Hamburger.mapper.OrdersMapper;
import com.gyh.Hamburger.service.*;
...
public class  OrdersServiceImp extends ServiceImpl<OrdersMapper, Orders>
    ...
    public void submit(Orders orders){
        ...
        long orderId = IdWorker.getId();  // mybatis plus 提供的生成订单号的工具
